...
void RectangularCollisionStrategy::draw() const {
  ...
  IoMod::
  getInstance().writeText("Strategy: Rectangular", 580, 30, textColor);
}
...
void MidPointCollisionStrategy::draw() const {
  ...
  IoMod::
  getInstance().writeText("Strategy: Distance", 580, 30, textColor);
}
...
void PerPixelCollisionStrategy::draw() const {
  ...
  IoMod::
  getInstance().writeText("Strategy: Per-Pixel ", 580, 30, textColor);
}

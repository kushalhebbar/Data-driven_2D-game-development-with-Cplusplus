...
Triple Triple::scale(double s) const {
...
Triple Triple::sum(const Triple& a) const {
   return Triple(x+a.x, y+a.y, z+a.z);
}

Triple Triple::diff(const Triple& a) const {
   return Triple(x-a.x, y-a.y, z-a.z);
}

double Triple::dot(const Triple& a) const {
...
void Triple::boundingRect(const std::vector<Triple>& pts, double& x, double& y,
